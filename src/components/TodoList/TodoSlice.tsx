...
const TodoListSlice = createSlice({
    ...
    reducers: {
        ...
        setFilteredItems(state, action: PayloadAction<{ [key: string]: TodoItem }>) {
            state.filteredItems = action.payload;
        },
        ...
        handleUpdateStatus: (state, action: PayloadAction<{ name: string; status: string }>) => {
...
export const { setItems, setFilteredItems, setStatusFilter, setAvailableTags, setPriorityFilter, setDateFilter, setClickedItem, setItemToDelete, resetFilters, setTagFilter, setShowDeleteConfirm,handleCancelDelete,handleDateChange,handleDelete,handleItemClick,handlePriorityChange,handleStatusFilter,handleTagFilter,handleUpdateClick,handleUpdateStatus } = TodoListSlice.actions;
